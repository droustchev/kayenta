 ...
 */
package com.netflix.kayenta.retrofit;
...
public final class HttpLoggingInterceptor implements Interceptor {
  ...
  private final Slf4jRetrofitLogger logger;

  public HttpLoggingInterceptor(Slf4jRetrofitLogger logger) {
    this.logger = logger;
  }
  ...
  private boolean isDDHeader(String headerName) {
    return headerName.startsWith("DD");
  }
